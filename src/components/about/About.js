...
const About = ({ isDark }) => {
	...
	return (
		<section className='bg-background-light dark:bg-background-dark px-5 md:px-[100px] transition-colors duration-300 flex w-full justify-center items-center md:items-start md:justify-between py-10 flex-col  md:flex-row ' id='about'>
			<div className='md:w-1/2 mb-10 md:pb-auto '>
				<li className='flex items-center cursor-pointer mb-[15px] '>
				...
				<p className={`${isDark ? "text-text-dark" : "text-text-light"} text-2xl font-medium`}>
